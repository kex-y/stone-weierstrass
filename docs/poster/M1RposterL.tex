...
\vspace{3mm}
with the $\tt{M₀'.carrier}$ notation referring to the underlying subset of $\tt{M₀'}$ the subalgebra and $\tt{hc}$ the hypothesis that 
$\tt{M₀'.carrier}$ is closed under lattice operations.
