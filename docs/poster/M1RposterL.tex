...
Let us consider the approximation of $x^2$ using Bernstein polynomials,by calculating explicitly, we find the $n$-th Bernstein approximations of $x^2$ results in the sequence 
$$B_n(x)=\frac{1}{n} x + \frac{n-1}{n} x^2,$$
resulting $\sup_{x\in[-1, 1]} \left|x^2 - B_n(x) \right| = 2 / n$; much worse than just using $x^2$ as its own approximation.
\begin{center}
